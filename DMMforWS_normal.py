...
def main(args):
    ...
    for epoch in pbar:
        ...
        for which_mini_batch in range(N_mini_batches):
            ...
            samples = q0.sample((N_train_data,8, ))
            sample_batch, sample_batch_reversed, sample_batch_mask, sample_batch_seq_lengths \
                = poly.get_mini_batch(mini_batch_indices, samples,
            ...
            generated_mini_batch = dmm(sample_batch, sample_batch_reversed, sample_batch_mask, sample_batch_seq_lengths)
